/* pomp C snippet file: pomp_89b96be7eafd22fd0d01941ea60f910a */
/* Time: 2022-02-15 16:39:00.328 -0500 */
/* Salt: CE2E5BC576C0177AA7C63705 */
...
void __pomp_stepfn (double *__x, const double *__p, const int *__stateindex, const int *__parindex, const int *__covindex, const double *__covars, double t, double dt)
{
 ...
 double mybeta = exp(log(beta1*seas1 + beta2*seas2 + beta3*seas3 + beta4*seas4 + beta5*seas5 + beta6*seas6) - betat*(t-2010)); 
...
void R_init_pomp_89b96be7eafd22fd0d01941ea60f910a (DllInfo *info)
{
R_RegisterCCallable("pomp_89b96be7eafd22fd0d01941ea60f910a", "__pomp_load_stack_incr", (DL_FUNC) __pomp_load_stack_incr);
R_RegisterCCallable("pomp_89b96be7eafd22fd0d01941ea60f910a", "__pomp_load_stack_decr", (DL_FUNC) __pomp_load_stack_decr);
R_RegisterCCallable("pomp_89b96be7eafd22fd0d01941ea60f910a", "__pomp_rinit", (DL_FUNC) __pomp_rinit);
R_RegisterCCallable("pomp_89b96be7eafd22fd0d01941ea60f910a", "__pomp_stepfn", (DL_FUNC) __pomp_stepfn);
R_RegisterCCallable("pomp_89b96be7eafd22fd0d01941ea60f910a", "__pomp_rmeasure", (DL_FUNC) __pomp_rmeasure);
R_RegisterCCallable("pomp_89b96be7eafd22fd0d01941ea60f910a", "__pomp_dmeasure", (DL_FUNC) __pomp_dmeasure);
R_RegisterCCallable("pomp_89b96be7eafd22fd0d01941ea60f910a", "__pomp_to_trans", (DL_FUNC) __pomp_to_trans);
R_RegisterCCallable("pomp_89b96be7eafd22fd0d01941ea60f910a", "__pomp_from_trans", (DL_FUNC) __pomp_from_trans);
}

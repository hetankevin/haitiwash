/* pomp C snippet file: pomp_5dc10676d59457203281ddde101b16e2 */
/* Time: 2022-03-09 21:02:04.478 -0500 */
/* Salt: 385F15A421281FEB652B19F7 */
...
#define theta0		(__p[__parindex[10]])
#define alpha		(__p[__parindex[11]])
#define mu		(__p[__parindex[12]])
#define delta		(__p[__parindex[13]])
#define nu		(__p[__parindex[14]])
#define pop_0		(__p[__parindex[15]])
#define sig_sq		(__p[__parindex[16]])
#define S_0		(__p[__parindex[17]])
#define E_0		(__p[__parindex[18]])
#define I_0		(__p[__parindex[19]])
#define A_0		(__p[__parindex[20]])
#define R_0		(__p[__parindex[21]])
...
#define T_gamma		(__pt[__parindex[8]])
#define T_sigma		(__pt[__parindex[9]])
#define T_theta0		(__pt[__parindex[10]])
#define T_alpha		(__pt[__parindex[11]])
#define T_mu		(__pt[__parindex[12]])
#define T_delta		(__pt[__parindex[13]])
#define T_nu		(__pt[__parindex[14]])
#define T_pop_0		(__pt[__parindex[15]])
#define T_sig_sq		(__pt[__parindex[16]])
#define T_S_0		(__pt[__parindex[17]])
#define T_E_0		(__pt[__parindex[18]])
#define T_I_0		(__pt[__parindex[19]])
#define T_A_0		(__pt[__parindex[20]])
#define T_R_0		(__pt[__parindex[21]])
...
void R_init_pomp_5dc10676d59457203281ddde101b16e2 (DllInfo *info)
{
R_RegisterCCallable("pomp_5dc10676d59457203281ddde101b16e2", "__pomp_load_stack_incr", (DL_FUNC) __pomp_load_stack_incr);
R_RegisterCCallable("pomp_5dc10676d59457203281ddde101b16e2", "__pomp_load_stack_decr", (DL_FUNC) __pomp_load_stack_decr);
R_RegisterCCallable("pomp_5dc10676d59457203281ddde101b16e2", "__pomp_rinit", (DL_FUNC) __pomp_rinit);
R_RegisterCCallable("pomp_5dc10676d59457203281ddde101b16e2", "__pomp_stepfn", (DL_FUNC) __pomp_stepfn);
R_RegisterCCallable("pomp_5dc10676d59457203281ddde101b16e2", "__pomp_rmeasure", (DL_FUNC) __pomp_rmeasure);
R_RegisterCCallable("pomp_5dc10676d59457203281ddde101b16e2", "__pomp_dmeasure", (DL_FUNC) __pomp_dmeasure);
R_RegisterCCallable("pomp_5dc10676d59457203281ddde101b16e2", "__pomp_to_trans", (DL_FUNC) __pomp_to_trans);
R_RegisterCCallable("pomp_5dc10676d59457203281ddde101b16e2", "__pomp_from_trans", (DL_FUNC) __pomp_from_trans);
}

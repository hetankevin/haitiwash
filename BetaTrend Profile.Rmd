...
mcap(results$loglik, results$betat)[7][1]$fit %>%
  ...
  geom_point() + geom_smooth() + 
  geom_vline(xintercept = mcap(results$loglik, results$betat, confidence = 0.95)$ci[1])  +
    geom_vline(xintercept = mcap(results$loglik, results$betat, confidence = 0.95)$ci[2]) 
